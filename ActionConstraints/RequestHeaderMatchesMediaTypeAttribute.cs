...
namespace CourseLibrary.ActionConstraints
{
    ...
    public class RequestHeaderMatchesMediaTypeAttribute: Attribute, IActionConstraint
    {
        ...
        public RequestHeaderMatchesMediaTypeAttribute(string requestHeaderToMatch,string mediaType, params string [] otherMediaTypes)
        {
            ...
            //verifica os valores enviados se sao validos e inclui numa colecao
        ...
        public bool Accept(ActionConstraintContext context)
        {
            ...
            //se for um dos media type
            foreach( var mediaType in _mediaTypes)
            {
                var parsedMediaType = new MediaType(mediaType);
                if(parsedRequestMediaType.Equals(parsedRequestMediaType))
                {
                    return true;
                }
            }
